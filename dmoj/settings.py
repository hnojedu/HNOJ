...
ACE_URL = '/static/vnoj/ace/src-min-noconflict'
SELECT2_JS_URL = '/static/vnoj/select2/dist/js/select2.min.js'
SELECT2_CSS_URL = '/static/vnoj/select2/dist/css/select2.min.css'
